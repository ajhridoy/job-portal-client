...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-gray-900 text-green-400 rounded">
  <div className="grid grid-flow-col gap-4" data-aos="fade-right"
     data-aos-easing="linear"
     data-aos-duration="1000">
    <Link className="link link-hover">About us</Link> 
    <Link className="link link-hover">Contact</Link> 
    <Link to='/Jobs' className="link link-hover">Jobs</Link> 
    <Link to='/postJob' className="link link-hover">Post Job</Link>
  </div> 
  <div>
    <div className="grid grid-flow-col gap-4" data-aos="fade-left"
     data-aos-easing="linear"
